    ...
    <div className="doctor-card-container">
      <div className="doctor-card-details-container">
        ...
        <div className="doctor-card-details">
          <div className="doctor-card-detail-name">Dr. John Doe</div>
          <div className="doctor-card-detail-speciality">Carddilogy</div>
          <div className="doctor-card-detail-experience">{experience} years experience: 12 Years</div>
          <div className="doctor-card-detail-consultationfees">Ratings: 5/5</div>
        </div>
        {/* for reference  */}
        { /*<div>
